    ...
    if(props.CardType == "n"){
        ...
        return (
            <Box flexGrow="3" width="100%" display="flex" px="2rem" flexDirection="column" justifyContent="center" alignItems="center">
                <Box border="1px solid #adadad" display="flex" width="100%" maxWidth="60rem" alignItems="center" justifyContent="center" position="relative" height="40vh" top="-10%" sx={{ boxShadow: 8 }} borderRadius="0.6rem" px="3rem">
