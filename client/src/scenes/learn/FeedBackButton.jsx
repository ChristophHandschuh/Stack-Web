    ...
    return (
        <Box display="flex" justifyContent="center" my="1rem">
            <Box display="flex" alignItems="space-between">
                <Box onClick={() => props.feedback(false)} sx={{ boxShadow: 8, '&:hover': {border:"2px solid #e3021f"}}} backgroundColor="#fce3e6" mr="1rem" borderRadius="0.6rem" height="4rem" width="4rem" display="flex" alignItems="center" justifyContent="center">
                ...
                <Box onClick={() => props.feedback(true)} sx={{ boxShadow: 8, '&:hover': {border:"2px solid #04c444"}}} ml="1rem" backgroundColor="#d7fae2" borderRadius="0.6rem" height="4rem" width="4rem" display="flex" alignItems="center" justifyContent="center">
